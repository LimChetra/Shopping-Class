...
public class Shopping {
    public static void main(String[] args) {
        Customer c1 = new Customer("Lim Chetra", "Normal");
        Customer c2 = new Customer("Ho Dalin", "Premium");
        Customer c3 = new Customer("Oeng Sovanpanha", "Gold");
        Customer c4 = new Customer("Moun Sreynorn", "Silver");
